		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Report",
									"targetURL": "#brcomgestaofioriappadmin238-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomgestaofioriappadmin238-display": {
								"semanticObject": "brcomgestaofioriappadmin238",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.gestao.fioriappadmin238",
									"url": sap.ui.require.toUrl("br/com/gestao/fioriappadmin238")
								}
							}
						}
					}
